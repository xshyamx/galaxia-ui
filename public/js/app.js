...
var twbTransition = require("imports-loader?jQuery=jquery!bootstrap/js/transition");
var twbTooltip = require("imports-loader?jQuery=jquery!bootstrap/js/tooltip");
var twbPopover = require("imports-loader?jQuery=jquery!bootstrap/js/popover");

var appmodule = angular.module("MyApp1", [
  "ngRoute",
  "ngAnimate",
  "ngMessages"
]);
...
appmodule.factory("dashboardservices", [
  function() {
    var type = null;
    var port = null;
    var link = null;
    ...
    function removeDashboardWidget(widgetName) {
      if (dashboardData.widgets.indexOf(widgetName) != -1)
        return dashboardData.widgets.splice(
          dashboardData.widgets.indexOf(widgetName),
          1
        );
    }
    ...
    function removeMetric(metric) {
      var metricPosition = dashboardData.metrics
        .map(function(m) {
          return m.name;
        })
        .indexOf(metric.name);
